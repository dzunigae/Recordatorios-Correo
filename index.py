...
def reporte_correos_convocatorias(ADMINISTRADORES,NUEVAS_CONVOCATORIAS,YA_RESPONDIDAS,REPORTE,YA_RESPONDIDAS_OUT):
    ...
    HOJA_NUEVAS_CONVOCATORIAS_DF = HOJA_NUEVAS_CONVOCATORIAS_DF[['index','3. Correo electrónico','5. Programas académicos requeridos','15. Fecha de inicio de actividades']].copy()
    ...
    for i in HOJA_NUEVAS_CONVOCATORIAS_DF.index:
        SELECCIONADO = HOJA_NUEVAS_CONVOCATORIAS_DF.loc[i]
        PROGRAMAS = SELECCIONADO['5. Programas académicos requeridos']
        ...
        for j in LISTA_PROGRAMAS:
            ...
            REPORTE_DF = REPORTE_DF._append({
                ...
                'Fecha de inicio':SELECCIONADO['15. Fecha de inicio de actividades'],
            },ignore_index=True)
